...
\begin{tikzpicture}[node distance=2.8cm]
  \node[draw, rounded corners=3pt, fill=blue!10] (T1) {$T_1$};
  \node[draw, rounded corners=3pt, fill=green!10, right of=T1] (T2) {$T_2$};

  \node[draw, rounded corners=3pt, fill=purple!10, below left of=T2,
    yshift=-0.3cm, xshift=0.7cm] (inter) {\texttt{inter}};
  \node[draw, rounded corners=3pt, fill=orange!10, below right of=T1,
    yshift=-0.3cm, xshift=-0.7cm] (sup) {\texttt{sup}};
  \node[draw, rounded corners=3pt, fill=gray!10, above right of=T1,
    xshift=0.4cm] (prod) {\texttt{prod}};
  ...
  \node[below=0.3cm of inter, draw=none] {\small $T_1(i) \cap T_2(i)$};
  \node[below=0.3cm of sup, draw=none] {\small $T_1(i) \cup T_2(i)$};
  \node[above=0.3cm of prod, draw=none] {\small $T_1(i) \times T_2(i)$};
\end{tikzpicture}
